...
internal sealed class MainForm : Form
{
    ...
    private void BuildUi()
    {
        ...
        var capRuntimeNote = new Label
        {
            ...
            Text = $"Bundled default: CapFrameX {ProfilerServices.BundledCapFrameXVersion} stable portable release — requires .NET 10 Desktop Runtime. TOTAL Profiler configures only F11 + unlimited capture (0 s); CapFrameX keeps its own sound/UI defaults. Bundled captures: .\\Tools\\CapFrameX\\Portable\\Captures."
        };
